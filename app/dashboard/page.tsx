        ...
        {activeTab === "overview" && (<>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6 animate-fade-in-up animation-delay-200">
              ...
              <p className="text-lg font-mono font-bold text-blue-400">{user.accountNumber}</p>
              <button 
                onClick={() => {
                  navigator.clipboard.writeText(user.accountNumber);
                  showToast("Account number copied!", "success");
                }}
                className="text-xs text-[var(--muted)] hover:text-white mt-1 flex items-center gap-1"
              >
          ...
          <div className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                ...
                <div key={f.label}>
                  <label className="text-xs text-[var(--muted)]">{f.label}</label>
                  <p className={`text-sm font-medium mt-1 ${f.capitalize ? "capitalize" : ""} ${f.mono ? "font-mono text-blue-400" : ""}`}>{f.value}</p>
                </div>
              ))}
            </div>
          </div>
