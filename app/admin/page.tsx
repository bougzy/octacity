...
//               {/* // Add this button in your admin dashboard (e.g., next to total users) */}
//               <button
//                 onClick={runAccountNumberMigration}
//                 disabled={migrating}
//                 className="bg-blue-500/10 text-blue-400 px-3 py-1 rounded-lg text-xs hover:bg-blue-500/20 ml-2"
//               >
