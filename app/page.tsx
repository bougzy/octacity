    ...
    <div className="min-h-screen font-[family-name:var(--font-geist-sans)]">
      ...
      <section className="relative min-h-screen flex items-center justify-center hero-gradient pt-16">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg sm:text-xl text-[var(--muted)] max-w-2xl mx-auto mb-10 animate-fade-in-up animation-delay-200">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16 animate-fade-in-up animation-delay-400">
            <a href="#" className="btn-primary text-white px-8 py-3 rounded-lg text-lg font-medium w-full sm:w-auto">
              Get Started
            </a>
            <a href="#" className="btn-outline text-white px-8 py-3 rounded-lg text-lg font-medium w-full sm:w-auto">
              Sign In
            </a>
          </div>
          <div className="grid grid-cols-3 gap-8 max-w-lg mx-auto animate-fade-in-up animation-delay-600">
            <div>
      ...
      <section id="about" className="py-20 sm:py-28 bg-[var(--section-alt)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {/* Feature Card 1 */}
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
            ...
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
              ...
              <h3 className="text-lg font-semibold mb-2">Business Grants</h3>
              <p className="text-[var(--muted)] text-sm">Fuel your startup or scale your enterprise with targeted business funding.</p>
            </div>
            {/* Individual Grants */}
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
              <div className="w-12 h-12 rounded-lg bg-emerald-500/10 flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2">Individual Grants</h3>
              <p className="text-[var(--muted)] text-sm">Personal development and emergency support grants for qualifying individuals.</p>
            </div>
            {/* Office Capital */}
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
              <div className="w-12 h-12 rounded-lg bg-purple-500/10 flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2">Office Capital</h3>
              <p className="text-[var(--muted)] text-sm">Secure funding for office infrastructure, equipment, and workspace expansion.</p>
            </div>
            {/* General Grants */}
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
              <div className="w-12 h-12 rounded-lg bg-amber-500/10 flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2">General Grants</h3>
              <p className="text-[var(--muted)] text-sm">Flexible funding for a variety of projects and initiatives across all sectors.</p>
            </div>
            {/* School Grants */}
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
              <div className="w-12 h-12 rounded-lg bg-cyan-500/10 flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2">School Grants</h3>
              <p className="text-[var(--muted)] text-sm">Educational funding for institutions, students, and academic programs.</p>
            </div>
            {/* Women Empowerment */}
            <div className="card-hover bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
              <div className="w-12 h-12 rounded-lg bg-pink-500/10 flex items-center justify-center mb-4">
              ...
              <h3 className="text-lg font-semibold mb-2">Women Empowerment</h3>
              <p className="text-[var(--muted)] text-sm">Dedicated grants supporting women-led businesses and leadership programs.</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={testimonial.name} className="bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl p-6">
